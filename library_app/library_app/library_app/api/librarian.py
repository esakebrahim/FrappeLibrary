...
def return_book(loan_id: str):
    ...
    loan.return_date = datetime.now().date()  # Use date object, not string
    ...
    if reservations:
        ...
        if member_email:
            frappe.sendmail(
                ...
                message=f"Dear Member,<br><br>The book <strong>{loan.book_title}</strong> is now available. Please visit the library within 24 hours.<br><br>Thank you!",
            )
